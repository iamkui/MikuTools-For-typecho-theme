...
<fieldset class="nya-container">
  ...
  <br>
					<ul class="nya-list">
						...
						<li>
							<b>欢迎将本站收藏到收藏夹，以便以后使用</b>
						</li>
						<li>
                			本站域名：<a href="<?php $this->options->siteUrl(); ?>" target="_blank" rel="noopener noreferrer"><?php $this->options->siteUrl(); ?></a>　

                		</li>
                		<li>问题反馈和广告合作联系：<?php $this->options->BlogMail();?></li>
