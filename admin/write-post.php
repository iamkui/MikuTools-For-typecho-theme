        ...
        <div class="row typecho-page-main typecho-post-area" role="form">
            <form action="<?php $security->index('/action/contents-post-edit'); ?>" method="post" name="write_post">
                <div class="col-mb-12 col-tb-9" role="main">
                    ...
                    <p>工具地址：<input type="text" name="test_url" value="<?php $post->test_url(); ?>"/> 图片角标：<!--<input type="text" name="test_word" value="<?php $post->test_word(); ?>"/>--><select name="test_word">
                            	                                <option value="badge new">新功能</option>
                            	                            	<option value="badge hot">热门</option>
                            	                            	<option value="badge vip">VIP</option>
                            	                            	<option value="badge error">维护</option>
